...
func extractValueSET(result *wire.Result) interface{} {
	// Return the message which now contains "1" for successful operations
	// and "0" for operations that didn't modify the key
...
func TestSET(t *testing.T) {
	...
	testCases := []TestCase{
		...
		},
		{
			...
			expected:       []interface{}{"0", "", "1", "v9", "1", "v10"},
